    ...
    <div className='w-full h-screen flex justify-center items-center '>
      <div className='max-w-[1000px] w-full px-4 flex flex-col items-center'>
        <div className='max-w-[1000px] w-full sm:flex'>
          <h3 className='w-[110px] text-4xl font-bold border-b-4 border-[#2C3333] sm:ml-[385px]'> About </h3>
        </div>
        <div className='max-w-[1000px] w-full px-1 sm:flex'>
          <p className='text-4xl font-bold my-3 sm:w-[%50] text-right'>Hi, i'm Mariano, nice to meet you. Please take a look around. </p>
